  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h3 className="text-lg font-semibold">Select Target Persona</h3>
        <p className="text-muted-foreground text-sm">
          Choose the persona that will be used to evaluate the product variants
        </p>
      </div>
                ...
                <CommandList>
                  ...
                  <CommandGroup>
                    {personaData?.items?.map((persona) => (
                      ...
                      >
                        <Checkbox
                          checked={selectedPersona === persona._id}
                          onChange={() => {}}
                        />
      ...
      {selectedPersona && (
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium">
            {(() => {
              const selectedPersonaData = personaData?.items?.find(
                (p) => p._id === selectedPersona
              );
          ...
          >
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                ...
                <Checkbox
                  checked={selectedPersona === persona._id}
                  onChange={() => handlePersonaSelect(persona._id)}
                  className="ml-2"
                />
              </div>
            </CardHeader>
